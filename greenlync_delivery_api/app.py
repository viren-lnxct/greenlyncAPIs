...
def home():
    if(request.method == 'POST'):
        ...
        try:
            ...
            s3_client.upload_file(Bucket='greenlyncdelivery',Filename=filename_logo, Key=filename_logo+"_"+timestamp)
            bucket_location = s3_client.get_bucket_location(Bucket="greenlyncdelivery")
            image_s3url_logo = "https://s3-{0}.amazonaws.com/{1}/{2}".format(bucket_location['LocationConstraint'],"greenlyncdelivery",filename_logo+"_"+timestamp)
